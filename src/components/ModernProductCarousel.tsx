            ...
            <div className="relative container mx-auto">
                ...
                */}
                <div
                    ...
                    className="w-full pl-4 pr-3 flex overflow-x-auto scroll-snap-x-mandatory gap-3 pb-4 hide-scrollbar snap-x"
                    style={{
                ...
                >
                    {products.map((product) => (
                        <div
                            key={product.id}
                            className="flex-none w-[200px] md:w-[calc(25%-9px)] snap-start scroll-ml-4"
