        ...
        >
          <motion.div className="collection-card large" variants={fadeUpSlow}>
            ...
            <div className="collection-overlay">
              ...
              <Reveal delay={0.1}>
                <Link href="/shop?category=luxury,classic" className="btn-link">{t.home.view_more}</Link>
              </Reveal>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div className="flex flex-col items-center gap-4" variants={fadeUpSlow}>
              <div className="w-16 h-16 rounded-full bg-[#FCF8F3]/5 flex items-center justify-center text-[#d4af37] mb-2 transform transition-transform hover:scale-110 duration-300 trust-badge-icon">
