      ...
      >
        <div className="container mx-auto px-4 lg:px-8">
          <nav className="flex items-center justify-between">
            ...
            {/* Desktop Navigation */}
            <div className="hidden lg:flex items-center gap-8 ms-8">
                ...
                <AnimatePresence>
                  {showCategoryMenu && (
                    ...
                    >
                      <Link
                        href="/shop"
                        className="block px-6 py-3 text-sm text-[#12403C] hover:bg-[#FCF8F3] hover:text-[#d4af37] transition-colors font-medium text-start"
                      >
                        {t.nav.shop}
                      </Link>
            ...
            <div className="flex items-center gap-3 sm:gap-4 lg:gap-6">
                          ...
                          >
                            ...
                            <div className="space-y-px">
                              ...
                              <button
                                ...
                                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-[#FCF8F3] hover:text-[#12403C] rounded-lg transition-colors text-left"
                              >
                                <svg
                                  width="16"
                                  height="16"
              ...
              {/* Mobile Menu Toggle */}
              <button
                className="lg:hidden p-1 lg:p-2 -me-1 lg:-me-2 text-[#12403C]"
      ...
      >
        ...
        >
          ...
          {user && (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <svg className="ms-auto opacity-50 rtl:rotate-180" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            {user ? (
              <div className="border-t border-[#12403C]/10 pt-4 mt-4 space-y-1">
                ...
                <button
                  ...
                  className="flex items-center gap-3 w-full text-left text-gray-700 font-medium py-3 px-1 hover:bg-[#12403C]/5 rounded-lg transition-colors"
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" />
                    <polyline points="16 17 21 12 16 7" />
          ...
          <div className="p-4 text-center text-xs text-[#12403C]/50">
            {isRTL ? "اسحب لليمين للقفل" : "Swipe right to close"}
          </div>
        </div>
      </div>
    </div>
