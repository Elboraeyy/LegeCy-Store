  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2.5 sm:px-4 bg-white border border-gray-200 rounded-lg hover:border-[#d4af37] transition-colors text-sm font-medium text-gray-700"
      >
