...
export const dictionary = {
  en: {
    ...
    cart: {
      ...
      amount_away_from_free_shipping: "Add {amount} for Free Shipping",
      view_cart: "View Cart",
      checkout: "Checkout",
      secure_checkout: "Secure Checkout",
  ...
  ar: {
    ...
    home: {
      ...
      trust: {
        authentic: "دفع آمن",
        authentic_desc: "آمن ١٠٠٪",
        support: "خدمة عملاء",
        support_desc: "٢٤/٧",
        shipping: "شحن موثوق",
        shipping_desc: "سريع ومضمون",
        quality: "خامات عالية",
      ...
      legacy: {
        subtitle: "عراقة منذ 2025",
        title: "إرث من الدقة",
        description: "لأصحاب الذوق الرفيع الذين يقدّرون القيمة الخالدة. ليجاسي تختار لكم ساعات ليست مجرد أدوات لقياس الزمن، بل حراسٌ للتاريخ والأصالة.",
        btn: "استكشف عراقتنا",
      },
      promotions: {
        flash_sale: "فلاش سيل",
    ...
    cart: {
      ...
      amount_away_from_free_shipping: "أضف {amount} للحصول على شحن مجاني",
      view_cart: "عرض السلة",
      ...
      login_to_checkout: "سجل دخول لإتمام الشراء",
      one_size: "وان سايز",
