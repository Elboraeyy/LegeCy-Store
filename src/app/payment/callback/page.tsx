    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[var(--color-background)] p-4">
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
                ...
                <h1 className="text-2xl font-bold text-gray-800 mb-2">فشل الدفع / Payment Failed</h1>
                <p className="text-gray-600 mb-4">
                    لم نتمكن من إتمام عملية الدفع. من فضلك حاول مرة أخرى.
                    <br />
                    <span className="text-sm text-gray-500">Your payment could not be processed. Please try again.</span>
                </p>
                {errorMessage && (
                ...
                {orderId && (
                    <p className="text-sm text-gray-500 mb-4">
                        رقم الطلب: <span className="font-mono font-bold">{orderId.slice(0, 8)}</span>
                    </p>
                )}

                {/* Helpful tips */}
                <div className="bg-gray-50 rounded-lg p-4 mb-6 text-right">
                    <p className="text-sm font-semibold text-gray-700 mb-2">أسباب شائعة للفشل:</p>
                    <ul className="text-xs text-gray-600 space-y-1">
                        <li>• رصيد الكارت غير كافي</li>
                        <li>• البنك رفض العملية - حاول الاتصال بالبنك</li>
                ...
                <div className="space-y-3">
                    ...
                    {/* WhatsApp Support */}
                    <a
                        href="https://wa.me/201515205073?text=مرحباً، واجهت مشكلة في الدفع"
                        target="_blank"
