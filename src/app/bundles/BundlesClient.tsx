...
// Define interface based on usage in page.tsx
interface Bundle {
    id: string;
    type: string;
    slug: string;
            ...
            <div className="container mx-auto px-4 -mt-10 relative z-10">
                {bundles.length > 0 ? (
                                ...
                                <div className="relative h-[400px] bg-gray-100">
                                    ...
                                    <div className="absolute top-4 right-4">
                                        <span className="inline-block bg-[#d4af37] text-[#12403C] px-4 py-1.5 text-xs font-bold uppercase tracking-widest rounded-full shadow-lg">
                                            {bundle.savings > 0
                                                ? t.home.promotions.save + " " + formatPrice(bundle.savings)
                                                : t.home.promotions.bundle_deal}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-100">
                                        <div className="flex flex-col">
                                            <span className="text-gray-400 text-sm line-through">{formatPrice(bundle.originalPrice)}</span>
                                            <span className="text-2xl font-bold text-[#12403C]">{formatPrice(bundle.bundlePrice)}</span>
                                        </div>
                                        <span className="inline-flex items-center gap-2 text-[#d4af37] font-bold uppercase tracking-wider text-sm group-hover:translate-x-2 transition-transform">
                                            {bundle.type === 'MIX_AND_MATCH' ? t.home.promotions.customize : t.home.promotions.view_bundle}
                    ...
                    <div className="text-center py-20 bg-white rounded-2xl shadow-sm">
                        <p className="text-xl text-[#12403C]/60 mb-8">{t.home.promotions.no_active_bundles}</p>
