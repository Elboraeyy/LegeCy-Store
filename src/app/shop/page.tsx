  ...
  return (
    <ShopClient
      initialProducts={shopProducts.map((p) => ({
        ...
        categoryUseCustomOrder: p.categoryUseCustomOrder,
        sortInCategory: p.sortInCategory,
        brandSortOrder: p.brandSortOrder,
        brandUseCustomOrder: p.brandUseCustomOrder,
        sortInBrand: p.sortInBrand,
        materialSortOrder: p.materialSortOrder,
        materialUseCustomOrder: p.materialUseCustomOrder,
        sortInMaterial: p.sortInMaterial,
