                    ...
                    {(order.paymentMethod === 'wallet' || order.paymentMethod === 'instapay') && (
                        <div className="p-6 border-b border-gray-100 bg-[#e6fffa]">
                            ...
                            <a
                                ...
                                className="w-full text-center py-4 bg-[#25D366] text-white rounded-full font-bold hover:bg-[#128C7E] transition-all transform hover:-translate-y-1 hover:shadow-lg flex items-center justify-center gap-2 shadow-sm"
                            >
                    ...
                    <div className="p-6 print:hidden">
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-col sm:flex-row gap-3">
                                <Link 
                                    href={`/track/${orderId}`}
                                    className="flex-1 text-center py-4 border-2 border-[#12403C] text-[#12403C] rounded-full font-bold hover:bg-[#12403C] hover:text-white transition-all transform hover:-translate-y-1 hover:shadow-lg flex items-center justify-center gap-2"
                                >
                                ...
                                <Link 
                                    href="/shop"
                                    className="flex-1 text-center py-4 bg-[#12403C] text-white rounded-full font-bold hover:bg-[#0e3330] transition-all transform hover:-translate-y-1 hover:shadow-lg hover:shadow-[#12403C]/20 flex items-center justify-center gap-2"
                                >
                            ...
                            <button 
                                ...
                                className="w-full text-center py-4 bg-gray-100 text-[#12403C] rounded-full font-bold hover:bg-gray-200 transition-all transform hover:-translate-y-1 hover:shadow-lg flex items-center justify-center gap-2"
                            >
