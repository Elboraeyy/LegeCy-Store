    ...
    >
      ...
      <div className="absolute top-4 left-4 z-10 flex flex-col gap-2.5 pointer-events-none">
        ...
        {isNew && !isOnSale && !isOutOfStock && (
          <span
            className="product-badge !relative !top-auto !left-auto rounded-full"
            style={{ backgroundColor: "#12403C", color: "white" }}
          >
            {newLabel}
          </span>
        )}
          ...
          {allImages.map((_, idx) => (
            <motion.div
              ...
              animate={{
                ...
                backgroundColor:
                  selectedImageIndex === idx ? "#fff" : "rgba(255,255,255,0.4)",
              }}
...
export default function ProductDetailsClient({
  ...
  const applySitewideVisual =
    isSitewideEnabled && !isIndividuallyOnSale && !!product;

  const displayPrice =
    applySitewideVisual && product
      ? product.price - product.price * (sitewideTier1Percent / 100)
      : product?.price || 0;

  const displayComparePrice =
    applySitewideVisual && product ? product.price : product?.compareAtPrice;
  ...
  const handleShare = async (platform: string) => {
    ...
    const text = t.product.share_text.replace(
      "{name}",
        ...
        <div className="container">
          ...
          <div className="detail-split">
            ...
            <div className="detail-gallery">
              ...
              <div className="hidden md:block relative">
                ...
                >
                  ...
                  {isOutOfStock && (
                    <span className="product-badge stock-badge out">
                      {t.product.sold_out}
                    </span>
                  )}
            ...
            <div className="detail-content">
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  {product.detailTags.map((tag, idx) => {
                    ...
                    return color ? (
                      <span
                        key={idx}
                        className="px-2.5 py-1 text-[11px] font-extrabold text-white rounded-full tracking-tight uppercase shadow-sm"
              ...
              {/* Title */}
              <h1 className="detail-title-large">
                {getLocalized(product, language, "name")}
              </h1>
                    ...
                    <div className="notify-success">
                      ...
                      <p>
                        {notifyChannel === "whatsapp"
                          ? t.product.notify_me.success_whatsapp
                          : t.product.notify_me.success_email}
                      </p>
                    </div>
                  ) : (
                    <>
                          ...
                          try {
                            const res = await fetch("/api/notify", {
                              ...
                              body: JSON.stringify({
                                ...
                                ...(notifyChannel === "whatsapp"
                                  ? {
                                      whatsapp: notifyContact.replace(
                                        /\s/g,
                                        "",
                                      ),
                                    }
                            ...
                            if (res.ok) {
                              ...
                              if (notifyChannel === "whatsapp") {
                                ...
                                try {
                                  ...
                                  const { trackMetaContact } =
                                    await import("@/components/MetaPixel");
                              ...
                              if (data.message === "already_subscribed") {
                                toast.info(
                                  t.product.notify_me.already_subscribed,
                                );
                              }
                              setNotifyDone(true);
                            } else {
                      ...
                      >
                        <input
                          ...
                          placeholder={
                            notifyChannel === "whatsapp"
                              ? t.product.notify_me.whatsapp_placeholder
                              : t.product.notify_me.email_placeholder
                          }
                        ...
                        >
                          {notifyLoading
                            ? t.product.notify_me.submitting
                            : t.product.notify_me.submit}
                        </button>
                      </form>
                    </>
                  )}
              ...
              <div className="actions-secondary">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill={
                      isClient && isFav(product.id) ? "currentColor" : "none"
                    }
                    stroke="currentColor"
                    strokeWidth="2"
                  >
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    router.push(
                      `/compare?fromLabel=${getLocalized(product, language, "name")}`,
                    );
                  }}
              ...
              {/* Trust Badges */}
              <div
                className="product-trust-badges"
              ...
              <div className="product-accordions">
                ...
                {(product.description || product.detailedDescription) && (
                  <div
                    className={`accordion-item ${activeAccordion === "description" ? "open" : ""}`}
                  >
                    <button
                ...
                {/* Specifications */}
                <div
                  className={`accordion-item ${activeAccordion === "specs" ? "open" : ""}`}
                >
                  <button
                    className="accordion-header"
                    onClick={() =>
                          ...
                          {product.brand && (
                            <>
                              ...
                              <span className="spec-value">
                                {getLocalized(product.brand, language, "name")}
                              </span>
                            </>
                          )}
                          {product.category && (
                ...
                {/* Shipping */}
                <div
                  className={`accordion-item ${activeAccordion === "shipping" ? "open" : ""}`}
                >
                  <button
                    className="accordion-header"
                    onClick={() =>
                              ...
                              <li className="flex items-start gap-3">
                                ...
                                <div>
                                  <span className="font-semibold block text-foreground">
                                    {t.product.shipping_list.free_shipping.replace(
                                      "{amount}",
                                      formatPrice(Number(shippingThreshold)),
                                    )}
                                  </span>
                                </div>
                              </li>
                        ...
                        <div className="review-rating">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg
                              ...
                              viewBox="0 0 24 24"
                              fill={
                                star <= review.rating ? "var(--accent)" : "none"
                              }
                              stroke="var(--accent)"
                              strokeWidth="2"
                            >
                    ...
                    {[1, 2, 3, 4, 5].map((star) => (
                      ...
                      >
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          fill={
                            star <= reviewForm.rating ? "var(--accent)" : "none"
                          }
                          stroke="var(--accent)"
                          strokeWidth="2"
                        >
